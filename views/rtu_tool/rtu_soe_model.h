#ifndef RTU_SOE_MODEL_H
#define RTU_SOE_MODEL_H
...
class rtuSOEModel : public QAbstractTableModel {
    Q_OBJECT
   ...
   public:
    rtuSOEModel(QObject* parent = {}) : QAbstractTableModel{parent} {}
